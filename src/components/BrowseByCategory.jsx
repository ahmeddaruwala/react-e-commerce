    ...
    return (
      <>
        ...
        <div className="flex container-x my-5 pt-10 gap-8">
          ...
          <Test CategoriesIcon={<IoCameraOutline />} CategoriesName="Camera" />
          <Test CategoriesIcon={<CiHeadphones />} CategoriesName="HeadPhones" />
          <Test CategoriesIcon={<IoGameControllerOutline />} CategoriesName="Gaming" />
        </div>
